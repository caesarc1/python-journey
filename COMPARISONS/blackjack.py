...
def value_of_ace(card_one, card_two):
    ...
    if (
        ...
        or value_of_card(card_one) + value_of_card(card_two) + 11 > 21
    ):
        return 1
...
def is_blackjack(card_one, card_two):
    ...
    return ("A" in (card_one, card_two)) and (
        10 == value_of_card(card_one)
        or 10 == value_of_card(card_two)  # Ruff made this format and it's so beautiful!
    )
